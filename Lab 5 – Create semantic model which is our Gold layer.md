...
5.	Validate the relationships and cardinality – it should me Many to one where Fact is on the Many-side. This can be validated by seeing * on the Fact and 1 on Dimensionts:
...
Now you created a basic semantic model in Direct Lake mode. In real life, you will also define measures, hide columns and configure data categories & summarize by for relevant columns.
